...
exports.getRandom10Questions = void 0;
const ALL = [
    {
    ...
    {
        question: "Which of the following musical groups was formed in Liverpool in 1960?",
    ...
    {
        question: "Who is the protagonist in Herman Melville's epic novel 'Moby-Dick'?",
    ...
    {
        question: "Who is the protagonist in J.D. Salinger's novel 'The Catcher in the Rye'?",
        choices: [
            "Holden Caulfield",
            "Huckleberry Finn",
            "Jay Gatsby",
    ...
    {
        question: "Who was the first President of the United States to resign from office?",
        choices: [
            "Richard Nixon",
            "John F. Kennedy",
            "Lyndon B. Johnson",
    ...
    {
        question: "What is the process by which water returns to the Earth as precipitation?",
    ...
    {
        question: "Who was the ancient Greek philosopher who taught that 'all is water'?",
    ...
    {
        question: "Who wrote the famous novel 'The Adventures of Huckleberry Finn'?",
        choices: [
            "Mark Twain",
            "F. Scott Fitzgerald",
            "Ernest Hemingway",
    ...
    {
        question: "Who was the ancient Greek philosopher who taught that 'all is fire'?",
    ...
    {
        question: "What is the process by which the universe became transparent to light?",
        choices: ["Recombination", "Decoupling", "Ionization", "Nucleosynthesis"],
        answer: "Recombination",
        id: "r7tav",
    },
    {
        question: "Who is the protagonist in Fyodor Dostoevsky's novel 'Crime and Punishment'?",
        choices: [
            "Raskolnikov",
            "Sonya Marmeladova",
            "Dmitri Karamazov",
    ...
    {
        question: "Who is the author of the famous novel 'The Tenant of Wildfell Hall'?",
        choices: [
            "Anne Bronte",
            "Charlotte Bronte",
            "Emily Bronte",
    ...
    {
        question: "Who is the author of the famous novel 'The Adventures of Huckleberry Finn'?",
        choices: [
            "Mark Twain",
            "Herman Melville",
            "Edgar Allan Poe",
    ...
    {
        question: "Which musician is often referred to as the 'King of Rock and Roll'?",
        choices: [
            "Elvis Presley",
            "Chuck Berry",
            "Little Richard",
    ...
    {
        question: "Which novel by Jane Austen begins with the line 'It is a truth universally acknowledged...'?",
        choices: [
            "Pride and Prejudice",
    ...
    {
        question: "The highest mountain peak in North America is located in which state?",
    ...
    {
        question: "The highest mountain peak in South America is located in which country?",
    ...
    {
        question: "The highest mountain peak in Europe is located in which country?",
    ...
    {
        question: "The novel 'The Picture of Dorian Gray' was written by which author?",
        choices: [
            "Oscar Wilde",
            "Bram Stoker",
            "Mary Shelley",
    ...
    {
        question: "The highest mountain peak in Africa is located in which country?",
    ...
    {
        question: "The novel 'The Adventures of Huckleberry Finn' was written by which author?",
        choices: [
            "Mark Twain",
            "Herman Melville",
            "Edgar Allan Poe",
    ...
    {
        question: "The novel 'The Count of Monte Cristo' was written by which author?",
        choices: [
            "Alexandre Dumas",
            "Victor Hugo",
            "Gustave Flaubert",
    ...
    {
        question: "The novel 'The Adventures of Tom Sawyer' was written by which author?",
        choices: [
            "Mark Twain",
            "Herman Melville",
            "Edgar Allan Poe",
    ...
    {
        question: "Which of the following authors wrote the novel 'Pride and Prejudice'?",
    ...
    {
        question: "Who is the main character in Herman Melville's novel 'Moby-Dick'?",
    ...
    {
        question: "The ' Treaty of Rome' established which international organization?",
        choices: ["European Union", "NATO", "UNESCO", "OECD"],
        answer: "European Union",
        id: "flkso",
    },
    {
        question: "The 'Great Wall of China' was built to protect the country from which nomadic group?",
    ...
    {
        question: "The 'Rio Grande' river forms part of the border between which two countries?",
        choices: [
            "US and Mexico",
            "US and Canada",
    ...
    {
        question: "The 'Bachata' is a type of music and dance originating from which country?",
    ...
    {
        question: "The 'Yankee Stadium' is a baseball stadium located in which city?",
        choices: ["New York", "Los Angeles", "Chicago", "Boston"],
        answer: "New York",
        id: "lflef",
    },
    {
        question: "The term 'Quarantine' originated from the Italian phrase for which number?",
        choices: ["20", "30", "40", "50"],
        answer: "40",
        id: "8xvvl",
    },
    {
        question: "The 'UNESCO World Heritage Site' of 'Angkor Wat' is located in which country?",
        choices: ["Cambodia", "Thailand", "Vietnam", "Laos"],
        answer: "Cambodia",
        id: "jrn32",
    },
    {
        question: "The 'Guggenheim Museum' in Bilbao, Spain was designed by which architect?",
        choices: ["Frank Gehry", "I.M. Pei", "Frank Lloyd Wright", "Le Corbusier"],
        answer: "Frank Gehry",
        id: "j5btg",
    },
    {
        question: "The 'Hadron Collider' is a scientific instrument used to study which phenomenon?",
    ...
    {
        question: "The 'Vivaldi' concertos are famous for their use of which instrument?",
    ...
    {
        question: "The 'World Wide Web' was invented by which British computer scientist?",
        choices: ["Tim Berners-Lee", "Alan Turing", "Steve Jobs", "Bill Gates"],
        answer: "Tim Berners-Lee",
        id: "ug0n8",
    },
    {
        question: "The 'X Games' are an annual extreme sports event held in which country?",
    ...
    {
        question: "The 'Zoroastrianism' religion originated in which ancient empire?",
    ...
    {
        question: "The 'Francis Crick' institute is a biomedical research center located in which city?",
    ...
    {
        question: "The 'Kremlin' is a historic fortified complex located in which city?",
    ...
    {
        question: "The 'Periodic Table' of elements was developed by which Russian chemist?",
        choices: [
            "Dmitri Mendeleev",
            "Antoine Lavoisier",
            "John Dalton",
    ...
    {
        question: "The 'Rosetta Stone' is an ancient Egyptian artifact that features which three languages?",
        choices: [
    ...
    {
        question: "The 'Umbrella Revolution' was a democratic protest movement that took place in which country?",
        choices: ["Hong Kong", "Taiwan", "South Korea", "Japan"],
        answer: "Hong Kong",
        id: "fqax6",
    },
    {
        question: "The 'Vatican City' is an independent city-state located within which country?",
        choices: ["Italy", "Vatican City", "Switzerland", "Austria"],
        answer: "Italy",
        id: "mmfru",
    },
    {
        question: "The 'Wimbledon Championships' is a tennis tournament held in which city?",
        choices: ["London", "Paris", "New York", "Melbourne"],
        answer: "London",
        id: "sr52p",
    },
    ...
    {
        question: "The 'Yellow Brick Road' is a fictional road in which classic novel?",
        choices: [
            "The Wizard of Oz",
            "Alice in Wonderland",
    ...
    {
        question: "The 'Zodiac' is a circle of twelve signs, each representing a different...",
    ...
    {
        question: "Under which article of the US Constitution is the power of impeachment outlined?",
    ...
    {
        question: "Which instrument is often associated with the jazz musician Louis Armstrong?",
    ...
    {
        question: "Which musical instrument is often associated with the country of Scotland?",
    ...
    {
        question: "Which of the following scientists is credited with the discovery of gravity?",
        choices: [
            "Galileo Galilei",
            "Isaac Newton",
            "Albert Einstein",
    ...
    {
        question: "Which painting by Leonardo da Vinci is also known as 'La Gioconda'?",
    ...
    {
        question: "Which of the following authors wrote the novel 'To Kill a Mockingbird'?",
        choices: [
            "F. Scott Fitzgerald",
            "Harper Lee",
            "Jane Austen",
    ...
    {
        question: "The famous painting 'The Starry Night' was created by which artist?",
        choices: [
            "Vincent van Gogh",
            "Pablo Picasso",
            "Leonardo da Vinci",
    ...
    {
        question: "The highest waterfall in the world, Angel Falls, is located in which country?",
    ...
    {
        question: "The famous tennis tournament 'Wimbledon' is held in which country?",
        choices: ["England", "France", "Australia", "United States"],
        answer: "England",
        id: "2xhda",
    },
    {
        question: "The popular video game series 'Assassin's Creed' is developed by?",
    ...
    {
        question: "The famous physicist 'Albert Einstein' was born in which country?",
        choices: ["Germany", "Austria", "Switzerland", "France"],
        answer: "Germany",
        id: "swpfo",
    },
    {
        question: "The popular video game series 'Grand Theft Auto' is developed by?",
    ...
    {
        question: "The famous music group 'The Rolling Stones' was formed in which year?",
    ...
    {
        question: "The famous physicist 'Stephen Hawking' was born in which country?",
        choices: ["England", "Scotland", "Wales", "Ireland"],
        answer: "England",
        id: "4937u",
    },
    ...
    {
        question: "The famous novel 'Pride and Prejudice and Zombies' was written by?",
        choices: [
            "Seth Grahame-Smith",
            "Jane Austen",
            "Stephenie Meyer",
    ...
    {
        question: "The famous physicist 'Richard Feynman' was born in which country?",
    ...
    {
        question: "The famous physicist 'Erwin Schrodinger' was born in which country?",
    ...
    {
        question: "What is the world's largest island, located in the Arctic Ocean?",
    ...
    {
        question: "Which island nation is located in the Pacific Ocean and is known for its chocolate?",
    ...
    {
        question: "What is the highest mountain peak in the Caucasus mountain range?",
        choices: [
            "Mount Elbrus",
            "Mount Kazbek",
            "Mount Dykh-Tau",
    ...
    {
        question: "What is the highest mountain peak in the Sierra Nevada mountain range?",
        choices: [
            "Mount Whitney",
            "Mount Williamson",
            "Mount Tyndall",
    ...
    {
        question: "What is the highest mountain peak in the Cascades mountain range?",
        choices: [
            "Mount Rainier",
            "Mount Baker",
            "Mount St. Helens",
    ...
    {
        question: "Which mountain range runs along the border between China and Nepal?",
    ...
    {
        question: "What is the largest island in the Federated States of Micronesia?",
    ...
    {
        question: "What is the largest island in the Republic of the Marshall Islands?",
    ...
    {
        question: "Which iconic sitcom is set in a Boston bar where everyone knows your name?",
        choices: [
            "Friends",
    ...
    {
        question: "Which actress played the role of Katniss Everdeen in The Hunger Games film series?",
        choices: [
            "Jennifer Lawrence",
            "Shailene Woodley",
            "Emma Stone",
    ...
    {
        question: "Which 1994 Disney movie features the songs 'Hakuna Matata' and 'Can You Feel the Love Tonight'?",
    ...
    {
        question: "What was the name of the famous sitcom that aired from 1994 to 2004 and starred Jennifer Aniston, Courteney Cox, and Lisa Kudrow?",
        choices: [
            "Friends",
            "Seinfeld",
            "The Big Bang Theory",
    ...
    {
        question: "Which musician is known for hits like 'Purple Rain' and 'When Doves Cry'?",
        choices: ["Michael Jackson", "Elvis Presley", "David Bowie", "Prince"],
        answer: "Prince",
        id: "5c6y0",
    },
    {
        question: "What was the name of the famous video game character created by Shigeru Miyamoto?",
    ...
    {
        question: "Which actress played the role of Rachel Green in the TV show 'Friends'?",
        choices: [
            "Courteney Cox",
            "Jennifer Aniston",
            "Lisa Kudrow",
    ...
    {
        question: "Which actor played the role of Sherlock Holmes in the BBC TV series 'Sherlock'?",
        choices: [
    ...
    {
        question: "What was the name of the famous music group formed in 1962, known for hits like 'I Want to Hold Your Hand' and 'Yesterday'?",
        choices: ["The Rolling Stones", "The Beatles", "Queen", "Led Zeppelin"],
        answer: "The Beatles",
        id: "kj5iw",
    },
    {
        question: "Which actor played the role of the villainous Joker in the 2008 movie 'The Dark Knight'?",
    ...
    {
        question: "Which British rock band, formed in 1964, is known for hits like 'Stairway to Heaven' and 'Whole Lotta Love'?",
        choices: ["The Rolling Stones", "The Beatles", "Led Zeppelin", "Queen"],
        answer: "Led Zeppelin",
        id: "2zh9u",
    },
    {
        question: "Who played the role of the titular character in the TV show 'Doctor Who' from 2010 to 2013?",
        choices: [
            "Matt Smith",
            "David Tennant",
    ...
    {
        question: "Which actress played the role of Leslie Knope in the TV show 'Parks and Recreation'?",
        choices: ["Amy Poehler", "Tina Fey", "Julia Louis-Dreyfus", "Kristen Wiig"],
        answer: "Amy Poehler",
        id: "lc0w7",
    },
    {
        question: "Which actor played the role of James Bond in the 2006 movie 'Casino Royale'?",
    ...
    {
        question: "Which actor played the role of the villainous Magneto in the X-Men film series?",
        choices: [
            "Ian McKellen",
            "Patrick Stewart",
            "Hugh Jackman",
    ...
    {
        question: "Which actress played the role of Dorothy Gale in the 1939 movie 'The Wizard of Oz'?",
        choices: [
            "Judy Garland",
            "Marilyn Monroe",
            "Audrey Hepburn",
    ...
    {
        question: "Which band, formed in 1973, is known for hits like 'Stairway to Heaven' and 'Whole Lotta Love'?",
    ...
    {
        question: "Which actor played the role of Captain America in the Marvel Cinematic Universe?",
        choices: [
            "Chris Evans",
            "Chris Hemsworth",
            "Robert Downey Jr.",
    ...
    {
        question: "Which musician is known for hits like 'Imagine' and 'Revolution'?",
        choices: [
            "John Lennon",
            "Paul McCartney",
            "George Harrison",
    ...
    {
        question: "Which actor played the role of Thor in the Marvel Cinematic Universe?",
        choices: [
            "Chris Hemsworth",
            "Tom Hiddleston",
            "Idris Elba",
    ...
    {
        question: "Which actress played the role of Lois Lane in the 2013 movie 'Man of Steel'?",
        choices: ["Amy Adams", "Jessica Chastain", "Emma Stone", "Saoirse Ronan"],
        answer: "Amy Adams",
        id: "oety7",
    },
    {
        question: "Which musician is known for hits like 'Hound Dog' and 'Jailhouse Rock'?",
        choices: [
            "Elvis Presley",
            "Chuck Berry",
            "Little Richard",
    ...
    {
        question: "Which actress played the role of Emma Swan in the TV show 'Once Upon a Time'?",
        choices: [
            "Jennifer Morrison",
            "Ginnifer Goodwin",
            "Lana Parrilla",
    ...
    {
        question: "Which musician is known for hits like 'We Are the Champions' and 'Bohemian Rhapsody'?",
        choices: ["Freddie Mercury", "Brian May", "Roger Taylor", "John Deacon"],
        answer: "Freddie Mercury",
        id: "ic3kv",
    },
    {
        question: "Which actor played the role of the titular character in the TV show 'Sherlock'?",
        choices: [
            "Benedict Cumberbatch",
            "Tom Hiddleston",
            "Martin Freeman",
    ...
    {
        question: "Which musician is known for hits like 'Stairway to Heaven' and 'Whole Lotta Love'?",
        choices: ["Led Zeppelin", "The Rolling Stones", "Queen", "The Who"],
        answer: "Led Zeppelin",
        id: "uv7wq",
    },
    {
        question: "Which actor played the role of Bruce Wayne/Batman in Christopher Nolan's The Dark Knight Trilogy?",
        choices: [
            "Christian Bale",
            "Robert Pattinson",
            "Michael Keaton",
    ...
    {
        question: "Which 1984 film starring Eddie Murphy and Dan Aykroyd follows two men who are forced to trade places as part of a bet between two wealthy businessmen?",
        choices: [
            "Trading Places",
    ...
    {
        question: "Which 1990s TV show set in New York City starred Sarah Michelle Gellar as Buffy Summers?",
        choices: ["Buffy the Vampire Slayer", "Angel", "Charmed", "Roswell"],
        answer: "Buffy the Vampire Slayer",
        id: "7gahg",
    },
    {
        question: "Which musician is known for hits like 'Born to Run' and 'Dancing in the Dark'?",
        choices: ["Bruce Springsteen", "Bob Seger", "Tom Petty", "John Mellencamp"],
        answer: "Bruce Springsteen",
        id: "tf7u3",
    },
    {
        question: "Which actor played the role of Carl Fredricksen in the Pixar film 'Up'?",
        choices: [
            "Edward Asner",
            "Christopher Plummer",
            "John Ratzenberger",
    ...
    {
        question: "Which 1975 film about a killer shark was based on a novel by Peter Benchley?",
        choices: ["Jaws", "Deep Blue Sea", "The Shallows", "Open Water"],
        answer: "Jaws",
        id: "77528",
    },
    {
        question: "Which actress played the role of Samantha Carter in the TV show 'Stargate SG-1'?",
        choices: [
            "Amanda Tapping",
            "Christina Cox",
            "Laura Vandervoort",
    ...
    {
        question: "Which musician is known for hits like 'Uptown Funk' and 'Just the Way You Are'?",
        choices: ["Bruno Mars", "Mark Ronson", "The Weeknd", "Pharrell Williams"],
        answer: "Bruno Mars",
        id: "5wfpy",
    },
    {
        question: "Which 1962 film starring Audrey Hepburn as Holly Golightly is based on a novella by Truman Capote?",
        choices: [
    ...
    {
        question: "Which actor played the role of Steve Urkel in the TV show 'Family Matters'?",
        choices: [
            "Jaleel White",
            "Reginald VelJohnson",
            "Darius McCrary",
    ...
    {
        question: "Which TV show is set in the fictional town of Stars Hollow, Connecticut?",
        choices: ["Gilmore Girls", "The O.C.", "Gossip Girl", "One Tree Hill"],
        answer: "Gilmore Girls",
        id: "3pv0w",
    },
    {
        question: "Which musician is known for hits like 'I Will Always Love You' and 'I Have Nothing'?",
        choices: ["Whitney Houston", "Mariah Carey", "Celine Dion", "Tina Turner"],
        answer: "Whitney Houston",
        id: "0fgnj",
    },
    {
        question: "Which actor played the role of Al Bundy in the TV show 'Married... with Children'?",
        choices: [
            "Ed O'Neill",
            "Christina Applegate",
            "David Faustino",
    ...
    {
        question: "Which 1986 film starring Tom Cruise as a hotshot fighter pilot is based on a novel by Ehud Yonay?",
        choices: [
            "Top Gun",
            "The Right Stuff",
    ...
    {
        question: "Which actress played the role of Lily Aldrin in the TV show 'How I Met Your Mother'?",
        choices: [
            "Alyson Hannigan",
            "Cobie Smulders",
            "Jennifer Morrison",
    ...
    {
        question: "Which musician is known for hits like 'Sweet Child O' Mine' and 'November Rain'?",
        choices: ["Axl Rose", "Slash", "Duff McKagan", "Matt Sorum"],
        answer: "Axl Rose",
        id: "iih36",
    },
    ...
    {
        question: "Which actor played the role of Dr. Gregory House in the TV show 'House M.D.'?",
        choices: [
            "Hugh Laurie",
            "Jesse Spencer",
            "Robert Sean Leonard",
    ...
    {
        question: "Which musician is known for hits like 'Viva la Vida' and 'Paradise'?",
        choices: ["Coldplay", "The Script", "OneRepublic", "The 1975"],
        answer: "Coldplay",
        id: "o3wg8",
    },
    {
        question: "Which actress played the role of Phoebe Buffay in the TV show 'Friends'?",
        choices: [
            "Lisa Kudrow",
            "Jennifer Aniston",
            "Courteney Cox",
    ...
    {
        question: "Which 1977 film starring John Travolta as a young man who becomes a disco dancing sensation is based on a novel by Nik Cohn?",
        choices: [
    ...
    {
        question: "Which musician is known for hits like 'Hotel California' and 'Desperado'?",
        choices: ["Eagles", "Lynyrd Skynyrd", "The Doobie Brothers", "America"],
        answer: "Eagles",
        id: "cc7cs",
    },
    {
        question: "Which actress played the role of Ellen Ripley in the Alien film series?",
    ...
    {
        question: "Which musician is known for hits like 'Purple Haze' and 'All Along the Watchtower'?",
        choices: ["Jimi Hendrix", "Eric Clapton", "Jeff Beck", "Pete Townshend"],
        answer: "Jimi Hendrix",
        id: "ho2zq",
    },
    {
        question: "Which actor played the role of Ross Geller in the TV show 'Friends'?",
        choices: [
            "David Schwimmer",
            "Matt LeBlanc",
            "Matthew Perry",
    ...
    {
        question: "Which 1984 film starring Eddie Murphy and Beverly Hills Cop is based on a screenplay by Vincent Patrick?",
        choices: [
            "Beverly Hills Cop",
            "Trading Places",
            "The Golden Child",
    ...
    {
        question: "Which musician is known for hits like 'Dancing Queen' and 'Mamma Mia'?",
        choices: ["ABBA", "The Bee Gees", "The Carpenters", "Fleetwood Mac"],
        answer: "ABBA",
        id: "9rdk4",
    },
    {
        question: "Which actress played the role of Buffy Summers in the TV show 'Buffy the Vampire Slayer'?",
        choices: [
    ...
    {
        question: "Which 1999 film starring Bruce Willis as a time traveler is based on a screenplay by Terry Rossio and Bill Marsilii?",
        choices: [
            "The Sixth Sense",
            "Twelve Monkeys",
            "Edge of Tomorrow",
    ...
    {
        question: "Which actor played the role of Michael Scott in the TV show 'The Office'?",
        choices: ["Steve Carell", "Rainn Wilson", "John Krasinski", "Ed Helms"],
        answer: "Steve Carell",
        id: "a7o60",
    },
    {
        question: "Which musician is known for hits like 'Bohemian Rhapsody' and 'We Will Rock You'?",
        choices: ["Queen", "Led Zeppelin", "The Rolling Stones", "Aerosmith"],
        answer: "Queen",
        id: "111vj",
    },
    {
        question: "Which 1975 film starring Al Pacino as a bank robber is based on a true story?",
        choices: [
            "Dog Day Afternoon",
            "The Godfather",
            "Scarface",
    ...
    {
        question: "Which actress played the role of Kelly Kapoor in the TV show 'The Office'?",
        choices: ["Mindy Kaling", "Ellie Kemper", "Angela Kinsey", "Jenna Fischer"],
        answer: "Mindy Kaling",
        id: "638bm",
    },
    {
        question: "Which actor played the role of Barney Stinson in the TV show 'How I Met Your Mother'?",
        choices: [
            "Neil Patrick Harris",
            "Josh Radnor",
            "Jason Segel",
    ...
    {
        question: "Which musician is known for hits like 'Sweet but Psycho' and 'High Hopes'?",
        choices: ["Ava Max", "Billie Eilish", "Lana Del Rey", "Halsey"],
        answer: "Ava Max",
        id: "6xowt",
    },
    {
        question: "Which actor played the role of Joey Tribbiani in the TV show 'Friends'?",
        choices: [
            "Matt LeBlanc",
            "Matthew Perry",
            "David Schwimmer",
    ...
    {
        question: "Which 1985 film starring Michael J. Fox as a high school student who travels back in time is based on a screenplay by Bob Gale and Robert Zemeckis?",
        choices: [
            "Back to the Future",
            "The Goonies",
            "Ghostbusters",
    ...
    {
        question: "Which actress played the role of Monica Geller in the TV show 'Friends'?",
        choices: [
            "Courteney Cox",
            "Jennifer Aniston",
            "Lisa Kudrow",
    ...
    {
        question: "Which musician is known for hits like 'SexyBack' and 'Suit & Tie'?",
        choices: [
            "Justin Timberlake",
            "Britney Spears",
            "Christina Aguilera",
    ...
    {
        question: "Which TV show is set in the fictional town of Quahog, Rhode Island?",
        choices: ["Family Guy", "American Dad!", "The Simpsons", "South Park"],
        answer: "Family Guy",
        id: "0bajp",
    },
    {
        question: "Which actor played the role of Sheldon Cooper in the TV show 'The Big Bang Theory'?",
        choices: ["Jim Parsons", "Johnny Galecki", "Kaley Cuoco", "Simon Helberg"],
        answer: "Jim Parsons",
        id: "rk45y",
    },
    {
        question: "Which musician is known for hits like 'Hips Don't Lie' and 'Whenever, Wherever'?",
        choices: ["Shakira", "Jennifer Lopez", "Ricky Martin", "Marc Anthony"],
        answer: "Shakira",
        id: "2jdc4",
    },
    {
        question: "Which 1994 film starring Tom Hanks as a character who is stranded on a deserted island is based on a novel by Daniel Defoe?",
        choices: ["Cast Away", "Forrest Gump", "Apollo 13", "Saving Private Ryan"],
        answer: "Cast Away",
        id: "tp1ng",
    },
    {
        question: "Which actress played the role of Carrie Bradshaw in the TV show 'Sex and the City'?",
        choices: [
    ...
    {
        question: "Which musician is known for hits like 'Yesterday' and 'Hey Jude'?",
        choices: [
            "Paul McCartney",
            "John Lennon",
            "George Harrison",
    ...
    {
        question: "Which actor played the role of Dwight Schrute in the TV show 'The Office'?",
        choices: [
            "Rainn Wilson",
            "Steve Carell",
            "John Krasinski",
    ...
    {
        question: "Which musician is known for hits like 'I Will Survive' and 'I Am Woman'?",
        choices: ["Gloria Gaynor", "Aretha Franklin", "Diana Ross", "Donna Summer"],
        answer: "Gloria Gaynor",
        id: "92ui7",
    },
    {
        question: "Which actor played the role of Chandler Bing in the TV show 'Friends'?",
        choices: [
            "Matthew Perry",
            "Matt LeBlanc",
            "David Schwimmer",
    ...
    {
        question: "Which 1962 film starring Audrey Hepburn as a princess who falls in love with a commoner is based on a novel by Erich Kästner?",
        choices: [
            "Roman Holiday",
            "Sabrina",
            "Funny Face",
    ...
    {
        question: "Which musician is known for hits like 'Satisfaction' and 'Paint It Black'?",
        choices: ["The Rolling Stones", "The Beatles", "The Who", "The Kinks"],
        answer: "The Rolling Stones",
        id: "f5p9r",
    },
    {
        question: "Which TV show is set in the fictional town of Mayberry, North Carolina?",
        choices: [
    ...
    {
        question: "Which actor played the role of Sam Malone in the TV show 'Cheers'?",
        choices: [
            "Ted Danson",
            "Woody Harrelson",
            "Kelsey Grammer",
    ...
    {
        question: "Which musician is known for hits like 'Jailhouse Rock' and 'Hound Dog'?",
        choices: ["Elvis Presley", "Chuck Berry", "Little Richard", "Bo Diddley"],
        answer: "Elvis Presley",
        id: "0i93s",
    },
    {
        question: "Which actress played the role of Emily Gilmore in the TV show 'Gilmore Girls'?",
        choices: [
            "Lauren Graham",
            "Alexis Bledel",
            "Melissa McCarthy",
    ...
    {
        question: "Which 1984 film starring Eddie Murphy as a con artist who poses as a preacher is based on a screenplay by Rudy De Luca and Barry W. Blaustein?",
        choices: [
            "The Golden Child",
            "Beverly Hills Cop",
            "Trading Places",
    ...
    {
        question: "Which TV show is set in the fictional town of Walnut Grove, Minnesota?",
        choices: [
    ...
    {
        question: "Which actor played the role of Barney Fife in the TV show 'The Andy Griffith Show'?",
        choices: ["Don Knotts", "Jim Nabors", "Andy Griffith", "Ron Howard"],
        answer: "Don Knotts",
        id: "fof7b",
    },
    {
        question: "Which 1975 film starring Robert De Niro as a young boxer is based on a screenplay by Paul Schrader?",
        choices: ["Raging Bull", "Taxi Driver", "The Deer Hunter", "Rocky"],
        answer: "Raging Bull",
        id: "zezoj",
    },
    {
        question: "Which musician is known for hits like 'Tiny Dancer' and 'Crocodile Rock'?",
    ...
    {
        question: "Which actress played the role of Ellen Ripley in the 'Alien' film franchise?",
        choices: [
            "Sigourney Weaver",
            "Linda Hamilton",
            "Jamie Lee Curtis",
    ...
    {
        question: "Which American singer-songwriter is known for hits like 'Respect' and 'Think'?",
        choices: ["Aretha Franklin", "Tina Turner", "Diana Ross", "Patti LaBelle"],
        answer: "Aretha Franklin",
        id: "gr0f7",
    },
    {
        question: "Which 1984 film starring Eddie Murphy and Dan Aykroyd follows two men who are forced to trade places as part of a bet?",
        choices: [
            "Trading Places",
            "The Prince and the Pauper",
            "Freaky Friday",
    ...
    {
        question: "Which American actress is known for her iconic roles in films like 'The Princess Bride' and 'When Harry Met Sally'?",
        choices: [
            "Meg Ryan",
            "Julia Roberts",
            "Sandra Bullock",
    ...
    {
        question: "Which British singer-songwriter is known for hits like 'Space Oddity' and 'Changes'?",
        choices: ["David Bowie", "Elton John", "Rod Stewart", "Freddie Mercury"],
        answer: "David Bowie",
        id: "ckgjc",
    },
    {
        question: "Which 1994 film starring Tom Hanks and Meg Ryan follows an online romance?",
        choices: [
            "You've Got Mail",
    ...
    {
        question: "Which actor played the role of Darth Vader in the original 'Star Wars' trilogy?",
        choices: [
            "David Prowse",
            "James Earl Jones",
            "Harrison Ford",
    ...
    {
        question: "Which American actress is known for her iconic roles in films like 'The Wizard of Oz' and 'Meet Me in St. Louis'?",
        choices: ["Judy Garland", "Doris Day", "Marilyn Monroe", "Audrey Hepburn"],
        answer: "Judy Garland",
        id: "r80eq",
    },
    {
        question: "Which 1985 film starring Michael J. Fox and Christopher Lloyd follows a time-traveling teenager?",
        choices: [
            "Back to the Future",
            "The Goonies",
            "Ghostbusters",
    ...
    {
        question: "Which British rock band, formed in 1968, is known for hits like 'Stairway to Heaven' and 'Whole Lotta Love'?",
        choices: ["Led Zeppelin", "Pink Floyd", "Queen", "The Who"],
        answer: "Led Zeppelin",
        id: "h89o1",
    },
    {
        question: "Which actor played the role of Clarice Starling in the 1991 film 'The Silence of the Lambs'?",
        choices: [
            "Jodie Foster",
            "Sigourney Weaver",
            "Linda Hamilton",
    ...
    {
        question: "Which American actress is known for her iconic roles in films like 'The Philadelphia Story' and 'Rear Window'?",
        choices: [
            "Katharine Hepburn",
            "Audrey Hepburn",
            "Ingrid Bergman",
    ...
    {
        question: "Which 1975 film starring Steven Spielberg and Roy Scheider follows a killer shark?",
        choices: [
            "Jaws",
    ...
    {
        question: "Which American singer-songwriter is known for hits like 'Purple Rain' and 'When Doves Cry'?",
        choices: ["Prince", "Michael Jackson", "David Bowie", "Elton John"],
        answer: "Prince",
        id: "znn2k",
    },
    {
        question: "Which actress played the role of Ellen DeGeneres's character's love interest in the sitcom 'Ellen'?",
        choices: [
            "Laura Dern",
            "Jennifer Aniston",
            "Courtney Cox",
    ...
    {
        question: "Which British singer-songwriter is known for hits like 'Space Age Love Song' and 'If You Leave'?",
        choices: ["A Flock of Seagulls", "The Cure", "Depeche Mode", "New Order"],
        answer: "A Flock of Seagulls",
        id: "6q99k",
    },
    {
        question: "Which 1994 film starring Tom Hanks and Meg Ryan follows a romantic relationship that develops through email exchanges?",
        choices: [
            "You've Got Mail",
            "Sleepless in Seattle",
            "When Harry Met Sally",
    ...
    {
        question: "Which American actress is known for her iconic roles in films like 'Roman Holiday' and 'Funny Face'?",
        choices: [
            "Audrey Hepburn",
            "Katharine Hepburn",
            "Ingrid Bergman",
    ...
    {
        question: "Which British rock band, formed in 1964, is known for hits like 'I Want to Hold Your Hand' and 'Yesterday'?",
        choices: ["The Beatles", "The Rolling Stones", "The Who", "Queen"],
        answer: "The Beatles",
        id: "rzcv4",
    },
    {
        question: "Which actor played the role of Luke Skywalker in the prequel trilogy of the 'Star Wars' franchise?",
        choices: [
            "Hayden Christensen",
            "Mark Hamill",
            "Ewan McGregor",
    ...
    {
        question: "Which American singer-songwriter is known for hits like 'Respect' and 'Chain of Fools'?",
        choices: ["Aretha Franklin", "Tina Turner", "Diana Ross", "Patti LaBelle"],
        answer: "Aretha Franklin",
        id: "8u8b3",
    },
    {
        question: "Which 1986 film starring Tom Cruise and Kelly McGillis follows a group of elite fighter pilots?",
        choices: [
            "Top Gun",
            "The Right Stuff",
            "Apollo 13",
    ...
    {
        question: "Which American actress is known for her iconic roles in films like 'The Exorcist' and 'Klute'?",
        choices: ["Ellen Burstyn", "Jane Fonda", "Glenn Close", "Meryl Streep"],
        answer: "Ellen Burstyn",
        id: "avdht",
    },
    {
        question: "Which British singer-songwriter is known for hits like 'Imagine' and 'Revolution'?",
        choices: [
            "John Lennon",
            "Paul McCartney",
            "George Harrison",
    ...
    {
        question: "Which 1994 film starring Keanu Reeves and Sandra Bullock follows a bus that must stay above 50 mph?",
        choices: ["Speed", "The Matrix", "Point Break", "John Wick"],
        answer: "Speed",
        id: "hb9uk",
    },
    {
        question: "Which American actor is known for his iconic roles in films like 'The Godfather' and 'Apocalypse Now'?",
        choices: ["Marlon Brando", "Al Pacino", "Robert De Niro", "Jack Nicholson"],
        answer: "Marlon Brando",
        id: "zzm5h",
    },
    {
        question: "Which British rock band, formed in 1964, is known for hits like 'Satisfaction' and 'Paint It Black'?",
        choices: ["The Rolling Stones", "The Beatles", "The Who", "Queen"],
        answer: "The Rolling Stones",
        id: "iyrif",
    },
    {
        question: "Which actress played the role of Katniss Everdeen in the 'Hunger Games' film franchise?",
        choices: [
            "Jennifer Lawrence",
            "Shailene Woodley",
            "Saoirse Ronan",
    ...
    {
        question: "Which American singer-songwriter is known for hits like 'Hound Dog' and 'Jailhouse Rock'?",
        choices: ["Elvis Presley", "Chuck Berry", "Little Richard", "Buddy Holly"],
        answer: "Elvis Presley",
        id: "a931b",
    },
    {
        question: "Which 1975 film starring Jack Nicholson and Louise Fletcher follows a rebellious patient at a mental institution?",
        choices: [
    ...
    {
        question: "Which British rock band, formed in 1970, is known for hits like 'Stairway to Heaven' and 'Whole Lotta Love'?",
        choices: ["Led Zeppelin", "Pink Floyd", "Queen", "The Who"],
        answer: "Led Zeppelin",
        id: "04dc8",
    },
    ...
    {
        question: "The D-Day invasion of Nazi-occupied France took place on which date?",
    ...
    {
        question: "The ancient city of Angkor Wat is located in which modern-day country?",
        choices: ["Thailand", "Cambodia", "Vietnam", "Laos"],
        answer: "Cambodia",
        id: "l6auu",
    },
    ...
    {
        question: "The Wright brothers made the first powered flight in which year?",
    ...
    {
        question: "The ancient city of Persepolis was located in which modern-day country?",
        choices: ["Iran", "Iraq", "Turkey", "Afghanistan"],
        answer: "Iran",
        id: "wj92t",
    },
    ...
    {
        question: "The ancient city of Ephesus was located in which modern-day country?",
    ...
    {
        question: "The Opium Wars took place between China and which European power?",
    ...
    {
        question: "The Mongol Empire was the largest contiguous empire in which century?",
        choices: ["13th", "14th", "15th", "16th"],
        answer: "13th",
        id: "3jytv",
    },
    ...
    {
        question: "The ancient city of Delphi was located in which modern-day country?",
        choices: ["Greece", "Turkey", "Rome", "Egypt"],
        answer: "Greece",
        id: "5s761",
    },
    {
        question: "The ancient Egyptians built the temples of Abu Simbel in which modern-day country?",
    ...
    {
        question: "The Kingdom of Kongo was a medieval kingdom located in which modern-day country?",
    ...
    {
        question: "The ancient city of Mohenjo-Daro was located in which modern-day country?",
    ...
    {
        question: "The ancient city of Angkor Wat was built in the 12th century by which king?",
        choices: [
            "Jayavarman VII",
            "Suryavarman II",
            "Indravarman I",
    ...
    {
        question: "The first permanent English settlement was established in which year?",
    ...
    {
        question: "The ancient city of Pompeii was buried under volcanic ash in which year?",
        choices: ["79 CE", "70 CE", "89 CE", "99 CE"],
        answer: "79 CE",
        id: "3309w",
    },
    {
        question: "The ancient Greeks developed the concept of which philosophical school?",
    ...
    {
        question: "The ancient city of Samarkand was an important stop on which trade route?",
    ...
    {
        question: "The ancient Egyptians built the Great Sphinx of Giza during which dynasty?",
        choices: [
            "Old Kingdom",
            "Middle Kingdom",
            "New Kingdom",
    ...
    {
        question: "The ancient city of Taxila was located in which modern-day country?",
        choices: ["Pakistan", "India", "Afghanistan", "Iran"],
        answer: "Pakistan",
        id: "dntum",
    },
    ...
    {
        question: "The ancient city of Palmyra was an important center of which ancient trade?",
    ...
    {
        question: "The first permanent Dutch settlement was established in which year?",
        choices: ["1624", "1626", "1628", "1630"],
        answer: "1626",
        id: "kujvy",
    },
    {
        question: "The ancient city of Paestum was founded by which ancient Greeks?",
        choices: ["Syracusans", "Spartans", "Athenians", "Phoenicians"],
        answer: "Syracusans",
        id: "vfned",
    },
    {
        question: "The English Reformation took place during the reign of which monarch?",
        choices: ["Henry VIII", "Edward VI", "Mary I", "Elizabeth I"],
        answer: "Henry VIII",
        id: "tpjrw",
    },
    {
        question: "The ancient city of Petra was carved into the rocks by which ancient civilization?",
    ...
    {
        question: "The ancient city of Carthage was founded by which Phoenician queen?",
    ...
    {
        question: "The ancient Greeks developed the concept of which scientific discipline?",
    ...
    {
        question: "The ancient city of Ephesus was an important center of which ancient cult?",
        choices: ["Christianity", "Paganism", "Judaism", "Dionysian Mysteries"],
        answer: "Christianity",
        id: "xin10",
    },
    {
        question: "The ancient city of Palenque was a major center of which civilization?",
        choices: ["Mayan", "Aztec", "Inca", "Olmec"],
        answer: "Mayan",
        id: "xgi00",
    },
    {
        question: "The United States dropped atomic bombs on which two Japanese cities?",
        choices: [
    ...
    {
        question: "The ancient city of Mohenjo-Daro was part of which ancient civilization?",
        choices: [
    ...
    {
        question: "The ancient city of Antioch was an important center of which early Christian community?",
        choices: [
            "Jewish-Christian",
            "Gentile-Christian",
            "Pauline-Christian",
    ...
    {
        question: "The ancient city of Nubia was located in which modern-day country?",
    ...
    {
        question: "The ancient city of Susa was an important center of which ancient empire?",
        choices: [
            "Persian Empire",
            "Achaemenid Empire",
            "Parthian Empire",
    ...
    {
        question: "The ancient city of Leptis Magna was an important center of which ancient civilization?",
    ...
    {
        question: "The ancient city of Persepolis was the capital of which ancient empire?",
        choices: [
            "Achaemenid Empire",
            "Parthian Empire",
            "Sassanian Empire",
    ...
    {
        question: "The United States dropped atomic bombs on which two Japanese cities in 1945?",
        choices: [
            "Hiroshima and Nagasaki",
            "Tokyo and Osaka",
            "Kyoto and Nara",
    ...
    {
        question: "The ancient city of Pergamon was an important center of which ancient civilization?",
    ...
    {
        question: "The ancient city of Ephesus was an important center of which early Christian community?",
        choices: [
            "Jewish-Christian",
            "Gentile-Christian",
            "Pauline-Christian",
    ...
    {
        question: "Which of the following tennis tournaments is NOT one of the four Grand Slam tournaments?",
        choices: [
            "Australian Open",
            "French Open",
            "Wimbledon",
    ...
    {
        question: "Which of the following cricketers is known as 'The God of Cricket'?",
        choices: [
            "Sachin Tendulkar",
            "Don Bradman",
            "Brian Lara",
    ...
    {
        question: "Who is the all-time leading wicket-taker in international cricket?",
        choices: [
    ...
    {
        question: "Which of the following Formula 1 drivers has won the most World Championships?",
        choices: [
            "Michael Schumacher",
            "Lewis Hamilton",
            "Juan Manuel Fangio",
    ...
    {
        question: "Which golfer is known for his iconic swing and his nickname 'The Golden Bear'?",
    ...
    {
        question: "Which of the following baseball players broke the color barrier in Major League Baseball?",
        choices: ["Jackie Robinson", "Babe Ruth", "Lou Gehrig", "Joe DiMaggio"],
        answer: "Jackie Robinson",
        id: "m7wx8",
    },
    {
        question: "Which cyclist won the Tour de France a record seven consecutive times?",
        choices: [
            "Lance Armstrong",
            "Miguel Indurain",
            "Bernard Hinault",
    ...
    {
        question: "Which of the following tennis players has won the most Grand Slam singles titles?",
        choices: [
            "Roger Federer",
            "Rafael Nadal",
            "Novak Djokovic",
    ...
    {
        question: "Which of the following Formula 1 teams has won the most Constructors' Championships?",
    ...
    {
        question: "Which of the following athletes has won the most Olympic gold medals?",
    ...
    {
        question: "Which of the following tennis players has won the most ATP Masters 1000 titles?",
    ...
    {
        question: "Which of the following cricketers has taken the most wickets in Test cricket?",
        choices: [
            "Muttiah Muralitharan",
            "Shane Warne",
            "Anil Kumble",
    ...
    {
        question: "Which of the following golfers has won the most major championships?",
        choices: ["Jack Nicklaus", "Arnold Palmer", "Gary Player", "Tiger Woods"],
        answer: "Jack Nicklaus",
        id: "7a0b1",
    },
    ...
    {
        question: "Which of the following tennis players has won the most Grand Slam singles titles in the Open Era?",
        choices: [
            "Serena Williams",
            "Steffi Graf",
            "Martina Navratilova",
    ...
    {
        question: "Which of the following athletes has won the most Olympic gold medals in individual events?",
        choices: ["Michael Phelps", "Mark Spitz", "Carl Lewis", "Paavo Nurmi"],
        answer: "Michael Phelps",
        id: "k1go5",
    },
    {
        question: "Which of the following tennis players has won the most ATP Tour titles?",
        choices: [
            "Roger Federer",
            "Rafael Nadal",
            "Novak Djokovic",
    ...
    {
        question: "Which of the following tennis players has won the most Grand Slam doubles titles?",
        choices: [
            "Martina Navratilova",
            "Billie Jean King",
            "Pam Shriver",
    ...
    {
        question: "Which of the following cricketers is known as 'The Master Blaster'?",
        choices: [
            "Sachin Tendulkar",
            "Sunil Gavaskar",
            "Vivian Richards",
    ...
    {
        question: "Which of the following athletes has won the most Olympic gold medals in team events?",
        choices: ["Michael Phelps", "Mark Spitz", "Carl Lewis", "Paavo Nurmi"],
        answer: "Michael Phelps",
        id: "0w0c6",
    },
    ...
    {
        question: "Which of the following cricketers is known as 'The Little Master'?",
        choices: [
            "Sachin Tendulkar",
            "Sunil Gavaskar",
            "Vivian Richards",
    ...
    {
        question: "Who is the only player to have won the Super Bowl, the NFL MVP award, and the Super Bowl MVP award in the same season?",
    ...
    {
        question: "Which of the following boxers was known for his 'peek-a-boo' defense?",
        choices: ["Mike Tyson", "Floyd Patterson", "Joe Frazier", "Jake LaMotta"],
        answer: "Floyd Patterson",
        id: "4vad3",
    },
    {
        question: "Who is the only player to have won the WNBA MVP, Finals MVP, and Olympic gold medal in the same year?",
        choices: [
            "Lisa Leslie",
            "Sheryl Swoopes",
            "Diana Taurasi",
    ...
    {
        question: "Which of the following cricketers has taken the most wickets in ODI cricket?",
        choices: [
            "Muttiah Muralitharan",
            "Wasim Akram",
            "Shane Warne",
    ...
    {
        question: "Which of the following tennis players has won the most doubles titles in the Open Era?",
        choices: [
            "Martina Navratilova",
            "Billie Jean King",
            "Chris Evert",
    ...
    {
        question: "Who is the only player to have won the NBA championship, MVP, and Finals MVP in the same season?",
        choices: [
            "Magic Johnson",
            "Kareem Abdul-Jabbar",
            "Larry Bird",
    ...
    {
        question: "Which of the following athletes has won the most gold medals in the Winter Olympics?",
        choices: [
    ...
    {
        question: "Who is the all-time leading scorer in the history of the NCAA Men's Division I Basketball Championship?",
        choices: [
            "Christian Laettner",
            "J.J. Redick",
            "Tyler Hansbrough",
    ...
    {
        question: "Who is the only player to have won the FIFA World Cup, the UEFA Champions League, and the Ballon d'Or in the same year?",
        choices: ["Lionel Messi", "Cristiano Ronaldo", "Zinedine Zidane", "Kaka"],
        answer: "Lionel Messi",
        id: "fke6a",
    },
    {
        question: "Which of the following tennis players has won the most singles titles in the Open Era?",
        choices: [
            "Roger Federer",
            "Rafael Nadal",
            "Novak Djokovic",
    ...
    {
        question: "Which of the following cricketers has scored the most centuries in international cricket?",
        choices: [
            "Sachin Tendulkar",
            "Jacques Kallis",
            "Ricky Ponting",
    ...
    {
        question: "Which of the following athletes has won the most Olympic medals in the history of the Winter Olympics?",
        choices: [
            "Norwegian biathlete Ole Einar Bjørndalen",
            "American speed skater Eric Heiden",
            "German luge athlete Georg Hackl",
    ...
    {
        question: "What is the term for the remains or imprints of ancient plants and animals?",
        choices: ["Fossils", "Rocks", "Minerals", "Gemstones"],
        answer: "Fossils",
        id: "zt1kg",
    },
    {
        question: "What is the scientific study of the structure, behavior, and evolution of the universe?",
        choices: ["Cosmology", "Astrology", "Astronomy", "Geology"],
        answer: "Cosmology",
        id: "qyisy",
    },
    {
        question: "What is the process by which the universe became transparent to light, occurring about 380,000 years after the Big Bang?",
        choices: ["Recursion", "Recombination", "Decoupling", "Expansion"],
        answer: "Recombination",
        id: "5zugs",
    },
    {
        question: "What is the term for a region in space where the gravitational pull is so strong that not even light can escape?",
    ...
    {
        question: "What is the scientific study of the structure, properties, and reactions of matter?",
        choices: ["Biology", "Chemistry", "Physics", "Geology"],
        answer: "Chemistry",
        id: "n7w6p",
    },
    {
        question: "What is the term for a substance that increases the rate of a chemical reaction without being consumed or altered?",
    ...
    {
        question: "What is the scientific study of the Earth's physical structure, composition, and processes?",
        choices: ["Geology", "Meteorology", "Oceanography", "Astronomy"],
        answer: "Geology",
        id: "esi6r",
    },
    {
        question: "What is the term for the movement of tectonic plates that can cause earthquakes and volcanic activity?",
        choices: ["Continental Drift", "Plate Tectonics", "Glaciation", "Erosion"],
        answer: "Plate Tectonics",
        id: "4x22v",
    },
    {
        question: "What is the scientific term for the 'study of the Earth's physical structure, composition, and processes'?",
        choices: ["Geology", "Meteorology", "Oceanography", "Astronomy"],
        answer: "Geology",
        id: "m8wvv",
    },
    ...
    {
        question: "What is the scientific study of the universe beyond the Earth's atmosphere?",
...
const EURO = [
    ...
    {
        question: "What is the name of the Armenian entry in the 2016 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the winner of the 2007 Eurovision Song Contest?",
        choices: [
            "Molitva",
    ...
    {
        question: "Who represented the United Kingdom in the 2016 Eurovision Song Contest?",
        choices: ["Joe and Jake", "Molly Smitten-Downes", "Electro Velvet", "Blue"],
        answer: "Joe and Jake",
        id: "ete1e",
    },
    {
        question: "What is the name of the Swedish entry in the 2012 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Cypriot entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the winner of the 2017 Eurovision Song Contest?",
        choices: [
            "Amar Pelos Dois",
            "Beautiful Mess",
            "Grab the Moment",
    ...
    {
        question: "What is the name of the winner of the 2013 Eurovision Song Contest?",
    ...
    {
        question: "Who represented the Netherlands in the 2019 Eurovision Song Contest?",
        choices: [
            "Duncan Laurence",
            "Waylon",
            "Ilse DeLange",
    ...
    {
        question: "What is the name of the Albanian entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Icelandic entry in the 2019 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Maltese entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Greek entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Azerbaijani entry in the 2018 Eurovision Song Contest?",
        choices: [
            "X My Heart",
            "When the Music Dies",
            "Running Scared",
    ...
    {
        question: "What is the name of the Czech entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Slovenian entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Israeli entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Belarusian entry in the 2017 Eurovision Song Contest?",
    ...
    {
        question: "How many times has the United Kingdom won the Eurovision Song Contest?",
        choices: ["5", "6", "4", "3"],
        answer: "5",
        id: "2xiav",
    },
    {
        question: "What is the name of the Croatian entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Hungarian entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "How many times has the Netherlands won the Eurovision Song Contest?",
        choices: ["5", "4", "3", "2"],
        answer: "5",
        id: "6vr2q",
    },
    {
        question: "What is the name of the Polish entry in the 2018 Eurovision Song Contest?",
        choices: [
            "Light Me Up",
            "In the Light",
            "Flashlight",
    ...
    {
        question: "What is the name of the Estonian entry in the 2019 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Montenegrin entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Georgian entry in the 2018 Eurovision Song Contest?",
        choices: [
            "For You",
            "Shine",
    ...
    {
        question: "What is the name of the Macedonian entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Danish entry in the 2018 Eurovision Song Contest?",
        choices: [
            "Higher Ground",
            "Soldiers of Love",
    ...
    {
        question: "What is the name of the Ukrainian entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Latvian entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Finnish entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Moldovan entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Norwegian entry in the 2018 Eurovision Song Contest?",
        choices: [
    ...
    {
        question: "What is the name of the Romanian entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Serbian entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the winner of the 1991 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Spanish entry in the 2017 Eurovision Song Contest?",
        choices: [
            "Occidentali's Karma",
            "Amar Pelos Dois",
            "Requiem",
    ...
    {
        question: "What is the name of the French entry in the 2018 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Slovenian winner of the Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the winner of the 1982 Eurovision Song Contest?",
        choices: [
            "Nicole",
            "Corinne Hermès",
    ...
    {
        question: "What is the name of the winner of the 2014 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Israeli entry in the 2017 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the winner of the 1984 Eurovision Song Contest?",
        choices: [
            "La det swinge",
            "Diggi-Loo Diggi-Ley",
            "Hard Rock Hallelujah",
    ...
    {
        question: "What is the name of the Dutch entry in the 2017 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the winner of the 2001 Eurovision Song Contest?",
        choices: [
            "I Wanna",
            "Everybody",
    ...
    {
        question: "What is the name of the winner of the 1996 Eurovision Song Contest?",
        choices: [
            "The Voice",
    ...
    {
        question: "What is the name of the winner of the 1987 Eurovision Song Contest?",
        choices: [
            "Hold Me Now",
            "Gente di mare",
            "Nur ein Lied",
    ...
    {
        question: "What is the name of the winner of the 1992 Eurovision Song Contest?",
        choices: [
            "Why Me?",
            "Fångad av en stormvind",
            "Rapariga do mar",
    ...
    {
        question: "What is the name of the winner of the 1993 Eurovision Song Contest?",
        choices: [
            "In Your Eyes",
    ...
    {
        question: "What is the name of the winner of the 1995 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the Slovenian entry in the 2017 Eurovision Song Contest?",
    ...
    {
        question: "What is the name of the winner of the 1994 Eurovision Song Contest?",
        choices: [
            "Rock 'n' Roll Kids",
            "To nie ja!",
            "Wijs me de weg",
    ...
    {
        question: "What is the name of the winner of the 1990 Eurovision Song Contest?",
        choices: [
            "Insieme: 1992",
            "Romeo",
            "Fångad av en stormvind",
    ...
    {
        question: "Which country has won the Eurovision Song Contest the most number of times?",
        choices: ["Ireland", "Sweden", "France", "United Kingdom"],
        answer: "Ireland",
        id: "sxdhr",
    },
    {
        question: "In what year did ABBA win the Eurovision Song Contest for Sweden?",
    ...
    {
        question: "Which country has participated in the Eurovision Song Contest the most number of times?",
        choices: ["United Kingdom", "France", "Germany", "Ireland"],
        answer: "United Kingdom",
        id: "omjfz",
    },
    {
        question: "Who represented the United Kingdom in the Eurovision Song Contest 2019?",
    ...
    {
        question: "In what year did Turkey last participate in the Eurovision Song Contest?",
        choices: ["2011", "2012", "2013", "2014"],
        answer: "2012",
        id: "3n1yq",
    },
    {
        question: "Which country has participated in the Eurovision Song Contest the least number of times?",
    ...
    {
        question: "Which country has participated in the Eurovision Song Contest the most consecutive years?",
        choices: ["United Kingdom", "France", "Germany", "Ireland"],
        answer: "United Kingdom",
        id: "g7ym8",
    },
    ...
    {
        question: "Which country has participated in the Eurovision Song Contest the most times without a win?",
    ...
    {
        question: "In what year did the Eurovision Song Contest first introduce semi-finals?",
    ...
    {
        question: "Which country has never participated in the Eurovision Song Contest?",
    ...
    {
        question: "Which country has participated in the Eurovision Song Contest the most times with the same singer?",
    ...
    {
        question: "In what year did the Eurovision Song Contest introduce the 50/50 jury-televoting system?",
        choices: ["2009", "2010", "2011", "2012"],
        answer: "2009",
        id: "qm60v",
    },
    ...
    {
        question: "Which country has never qualified for the Eurovision Song Contest final?",
    ...
    {
        question: "In what year did the Eurovision Song Contest first introduce the 'Big Five' rule?",
    ...
    {
        question: "Which country has participated in the Eurovision Song Contest the most times without being in the top 5?",
    ...
    {
        question: "In what year did the Eurovision Song Contest first introduce the 'televoting' system?",
    ...
    {
        question: "In what year did the Eurovision Song Contest first introduce the 'semi-final' system?",
        choices: ["2004", "2005", "2006", "2007"],
        answer: "2004",
        id: "vr2jc",
    },
    ...
    {
        question: "Which country has participated in the Eurovision Song Contest the most times with the same language?",
    ...
    {
        question: "In what year did the Eurovision Song Contest first introduce the 'jury voting' system?",
        choices: ["2009", "2010", "2011", "2012"],
        answer: "2009",
        id: "knp9e",
    },
    ...
    {
        question: "Which country has participated in the Eurovision Song Contest the most times without winning?",
        choices: ["Portugal", "Cyprus", "Iceland", "Malta"],
        answer: "Portugal",
        id: "fx2q4",
    },
    {
        question: "In what year did the Eurovision Song Contest first introduce the 'automatic qualification' rule?",
        choices: ["1999", "2000", "2001", "2004"],
        answer: "1999",
        id: "q88tp",
    },
    ...
    {
        question: "In what year did the Eurovision Song Contest first introduce the 'video jury' system?",
    ...
    {
        question: "In what year did the Eurovision Song Contest first introduce the 'online voting' system?",
    ...
    {
        question: "In what year did the Eurovision Song Contest first introduce the 'jury-televoting' system?",
    ...
    {
        question: "In what year did the Eurovision Song Contest first introduce the 'backing vocals' rule?",
    ...
    {
        question: "In what year did the Eurovision Song Contest first introduce the 'split jury-televoting' system?",
        choices: ["2013", "2014", "2015", "2016"],
        answer: "2013",
        id: "387h6",
    },
    ...
    {
        question: "Which country has won the Eurovision Song Contest the most times?",
        choices: ["Ireland", "Sweden", "France", "United Kingdom"],
        answer: "Ireland",
        id: "840st",
    },
    {
        question: "What is the name of the Swedish song that won Eurovision in 2012?",
    ...
    {
        question: "Which country has participated in Eurovision the most times without a win?",
    ...
    {
        question: "Who performed the Eurovision 2013 winning song 'Only Teardrops'?",
        choices: [
            "Emmelie de Forest",
            "Farid Mammadov",
            "Amandine Bourgeois",
    ...
    {
        question: "Which Eurovision song is known for its iconic 'douze points' lyrics?",
    ...
    {
        question: "Which country has never made it to the top 5 in the Eurovision final?",
    ...
    {
        question: "Which Eurovision winner was a member of the Irish girl group 'B*Witched'?",
        choices: ["Edele Lynch", "Keavy Lynch", "Niamh Kavanagh", "Lindsay Armaou"],
        answer: "Niamh Kavanagh",
        id: "6rf2r",
    },
    {
        question: "Which country has the highest average score in the Eurovision Song Contest?",
        choices: ["Sweden", "Ireland", "Luxembourg", "United Kingdom"],
        answer: "Sweden",
        id: "8khki",
    },
    {
        question: "Who wrote the lyrics for the winning song 'My Number One' in 2005?",
        choices: [
            "Christos Dantis",
            "Helena Paparizou",
            "Mikael Wendt",
    ...
    {
        question: "In what year did the Eurovision Song Contest introduce the 'Big Five' rule?",
    ...
    {
        question: "Which country has finished last in the Eurovision Song Contest the most times?",
    ...
    {
        question: "In what year did the Eurovision Song Contest introduce the semi-final system?",
    ...
    {
        question: "Which country has participated in Eurovision the most times without a top 5 placement?",
        choices: ["Portugal", "Cyprus", "Iceland", "Malta"],
        answer: "Cyprus",
        id: "6y9uo",
    },
    {
        question: "Who wrote the music for the winning song 'Hard Rock Hallelujah' in 2006?",
        choices: ["Lordi", "Mr. Lordi", "Awa", "H.P. Paananen"],
        answer: "Mr. Lordi",
        id: "fhc7a",
    },
    {
        question: "In what year did Lithuania debut in the Eurovision Song Contest?",
    ...
    {
        question: "Which country has won Eurovision the most times in the 21st century?",
    ...
    {
        question: "In what year did the Eurovision Song Contest introduce the 'juror ranking' system?",
        choices: ["2013", "2016", "2018", "2019"],
        answer: "2016",
        id: "2l15w",
    },
    {
        question: "Which country has participated in Eurovision the most times without a win in the 21st century?",
    ...
    {
        question: "In what year did Azerbaijan debut in the Eurovision Song Contest?",
        choices: ["2008", "2007", "2009", "2010"],
        answer: "2008",
        id: "27qj8",
    },
    {
        question: "Which country has participated in Eurovision the least times in the 21st century?",
        choices: [
            "Montenegro",
            "North Macedonia",
            "Bosnia and Herzegovina",
...
const getRandom10Questions = (exclude, theme = "all") => {
...
exports.getRandom10Questions = getRandom10Questions;
