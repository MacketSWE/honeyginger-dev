...
exports.getAvailabilityCheckerPrompt = exports.getFunctionCallingPrompt = void 0;
...
X-RUM-X`;
const getFunctionCallingPrompt = ({ city, query }) => {
    const data = (0, utils_1.getData)({ city, category: "mötesrum" });
    return [
        {
            role: "system",
      ...
      Det du ska göra är att läsa ut vilket mötesrum bokningen gäller och baserat på mötesrummets namn hämta rummets id från denna lista: ${JSON.stringify(data)}.
...
exports.getFunctionCallingPrompt = getFunctionCallingPrompt;
const getAvailabilityCheckerPrompt = ({ city, answer }) => {
    const data = (0, utils_1.getData)({ city, category: "id" });
    return [
        {
            role: "system",
...
exports.getAvailabilityCheckerPrompt = getAvailabilityCheckerPrompt;
module.exports = {
    getFunctionCallingPrompt: exports.getFunctionCallingPrompt,
    getAvailabilityCheckerPrompt: exports.getAvailabilityCheckerPrompt,
};
