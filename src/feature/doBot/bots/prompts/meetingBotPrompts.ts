...
export const getMeetingBotPrompts = (city: City) => {
  ...
  return [
    ...
    },
    {
      role: "user",
      content:
        "Nedan följer nu en exempelkonversation som du kan utgå ifrån. Exemplet handlar om en påhittad stad så datan har inget att göra med staden som du skall hjälpa till med, och siterna och rummen i exemplet är inte verkliga. Har du förstått?",
    },
    {
      role: "assistant",
      content: "Ja",
    ...
    },
    {
      role: "user",
      content:
        "Absolut, min email är marcus@test.com och fakturan kan skickas till inbox123@test.com",
    },
    {
      role: "assistant",
      content: `Tack Marcus!
    ...
    },
    {
      role: "user",
      content:
        "Använd tidigare svar som referens, men från och med nu är det en ny användare som ställer frågor. Du ska nu nollställa din information som testanvändaren gav om antalet personer och datum och site, med mera.",
    },
    {
      role: "assistant",
      content: `Jag förstår!`,
